...
int main(){
    ...
    int temp;
    std::cout << "Nhap vi tri cua phan tu trong mang muon tim: ";
    std::cin >> temp;
    ...
    std::cout << "Thoi gian chay cua thuat toan Binary Search (Tim kiem nhi phan): " << ((float)sum1 / (float)times) <<  " nanoseconds" << std::endl;
    std::cout << "Thoi gian chay cua thuat toan Jump Search (Tim kiem nhay): " << ((float)sum2 / (float)times) << " nanoseconds" << std::endl;
    std::cout << "Thoi gian chay cua thuat toan Linear Search (Tim kiem tuyen tinh): " << ((float)sum3 / (float)times) << " nanoseconds" << std::endl;
    std::cout << "Thoi gian chay cua thuat toan Ternary Search (Tim kiem tam phan): " << ((float)sum4 / (float)times) << " nanoseconds" << std::endl;
    std::cout << "Thoi gian chay cua thuat toan Fibonacci Search (Tim kiem Fibonacci): " << ((float)sum5 / (float)times) << " nanoseconds" << std::endl;
    std::cout << "Thoi gian chay cua thuat toan Exponential Search (Tim kiem mu): " << ((float)sum6 / (float)times) << " nanoseconds" << std::endl;    
    std::cout << "Thoi gian chay cua thuat toan Interpolation Search (Tim kiem noi suy): " << ((float)sum7 / (float)times) << " nanoseconds" << std::endl;
    std::cout << std::endl;
